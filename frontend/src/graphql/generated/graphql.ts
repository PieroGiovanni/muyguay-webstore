...
export type ProductPropsFragment = { __typename?: 'Product', id: number, name: string, price: number, description?: string | null, brandId: number, productTypeId: number, tags: Array<string>, isFeatured: boolean, createdAt: any, updatedAt: any, brand: { __typename?: 'Brand', name: string }, productType: { __typename?: 'ProductType', id: number, name: string, productCategoryId: number }, images: Array<{ __typename?: 'Image', imageUrl?: string | null, cloudinaryPublicId?: string | null }> } & { ' $fragmentName'?: 'ProductPropsFragment' };
